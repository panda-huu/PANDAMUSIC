...
_STRINGS = {
    ...
    'call_10': '<b>❖ sᴛᴀʀᴛ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ғɪʀsᴛ ʙᴀʙʏ 😆.',
    ...
    'help_1': '<b>❖ ᴄʜᴏᴏsᴇ ᴛʜᴇ ᴄᴀᴛᴇɢᴏʀʏ ғᴏʀ ᴡʜɪᴄʜ ʏᴏᴜ ᴡᴀɴɴᴀ ɢᴇᴛ ʜᴇʟᴩ.</b>\n<b>ᴀsᴋ ʏᴏᴜʀ ᴅᴏᴜʙᴛs ᴀᴛ <a href={0}>sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ</a></b>\n\n<b>❖ ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs ᴄᴀɴ ʙᴇ ᴜsᴇᴅ ᴡɪᴛʜ : <code>/</code></b>',
    ...
    'ping_1': '❖ {0} ɪs ᴘɪɴɢɪɴɢ...',
    'ping_2': '<b>● ᴘɪɴɢ : <code>{0}ᴍs</code>\n\n<u>{1} sᴛᴀᴛɪsᴛɪᴄs :</u>\n\n● ᴜᴩᴛɪᴍᴇ : {2}\n● ʀᴀᴍ ᴜsᴀɢᴇ : {3}\n● ᴄᴩᴜ ᴜsᴀɢᴇ : {4}\n● ᴅɪsᴋ ᴜsᴀɢᴇ : {5}\n● ᴩʏ-ᴛɢᴄᴀʟʟs : <code>{6}ᴍs</code></b>',
    'queue_1': '❖ ғᴇᴛᴄʜɪɴɢ ǫᴜᴇᴜᴇ...\n\nᴘʟᴇᴀsᴇ ᴡᴀɪᴛ...',
    'queue_2': '❖ ǫᴜᴇᴜᴇ ᴇᴍᴘᴛʏ.',
    'queue_3': '<u>❖ ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴄʜᴇᴄᴋ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴛʜᴇ ǫᴜᴇᴜᴇᴅ ᴛʀᴀᴄᴋs :</u> <a href={0}>ʜᴇʀᴇ</a>',
    'queue_4': '<blockquote><b>✨ ᴛʀᴀᴄᴋ ʀᴇsᴇʀᴠᴇᴅ — ᴘʟᴀʏɪɴɢ sᴏᴏɴ : #{0}</b></blockquote>\n<blockquote expandable><b>🎧 sᴏɴɢ :</b> {1}\n<b>🕚 ʟᴇɴɢᴛʜ :</b> {2} ᴍɪɴs\n<b>🥀 ʀᴇǫᴜᴇsᴛᴇʀ :</b> {3}\n\n<b>🎶 ɢᴇᴛ ʀᴇᴀᴅʏ! ʏᴏᴜʀ sᴏɴɢ ɪs ᴄᴏᴍɪɴɢ ᴜᴘ ɴᴇxᴛ.</b></blockquote>',
    ...
    'stream_1': '<blockquote><b>🎬 sᴛʀᴇᴀᴍ ʜᴀs sᴛᴀʀᴛᴇᴅ. ᴇɴᴊᴏʏ ᴛʜᴇ ᴍᴜsɪᴄ |</b></blockquote>\n<blockquote expandable><b>🎧 ᴛɪᴛʟᴇ :</b> <a href={0}>{1}</a>\n<b>⏱️ ʟᴇɴɢᴛʜ :</b> {2} ᴍɪɴs\n<b>🥀 ʀᴇǫᴜᴇsᴛᴇʀ :</b> {3}\u200e \u200e \u200e \u200e \u200e \u200e \u200e \u200e \u200e \u200e \u200e \u200e \u200e \u200e \u200e \u200e \u200e \u200e \u200e \u200e </blockquote>',
    'stream_2': '<blockquote><b>🎬 sᴛʀᴇᴀᴍ ʜᴀs sᴛᴀʀᴛᴇᴅ. ᴇɴᴊᴏʏ ᴛʜᴇ ᴍᴜsɪᴄ |</b></blockquote>\n<blockquote expandable><b>🎧 sᴛʀᴇᴀᴍ ᴛʏᴘᴇ :</b> ʟɪᴠᴇ sᴛʀᴇᴀᴍ [ 𝖴𝗋𝗅 ]\n<b>🥀 ʀᴇǫᴜᴇsᴛᴇʀ :</b> {0}</blockquote>',
    'CLOSE_BUTTON': 'ᴄʟσsє',
    'BACK_BUTTON': 'ʙᴧᴄᴋ',
    'NEXT_PAGE': '▷',
    'BACK_PAGE': '◁',
    ...
    'ABOUT_1': '<blockquote><b>❖ {0} sᴜᴘᴘᴏʀᴛ ɪηғσ :-</b>\n\n<b>● 24/7 ᴧᴠᴧɪʟᴧʙʟє ғσʀ ᴧηʏ ʙσᴛ.</b>\n<b>● ᴋᴇᴇᴘ ᴄʜᴧᴛ ᴄʟєᴧη ᴧηᴅ ʙᴜɢ-ғʀєє.</b>\n<b>● ᴧηʏ ᴘʀσʙʟєϻ ? ᴊᴜsᴛ ᴄσηᴛᴧᴄᴛ ᴜs.</b>\n─────────────────────────</b></blockquote>\n<blockquote expandable><b>● ᴡʀɪᴛᴛєη ɪη ➥ [ᴩʏᴛʜση](https://www.python.org/)</b>\n<b>● ᴅᴧᴛᴧʙᴧsє ➥ [ϻᴏηɢᴏ-ᴅʙ](https://www.mongodb.com/)</b>\n<b>● ʜєʟᴘ ᴡɪᴛʜ [ᴘʏʀᴏɢʀᴧϻ](https://github.com/pyrogram/pyrogram) & [ᴘʏ-ᴛɢᴄᴧʟʟs](https://github.com/pytgcalls/pytgcalls).</b>\n<b>● ɢɪᴛ ʜᴜʙ » [ɪᴛᴢsʜᴜᴋʟᴀ](https://github.com/itzshukla)</b>\n<b>─────────────────────────</b>\n<b>✦ ᴧ ϻᴜsɪᴄ ʙσᴛ ғσʀ ᴛɢ ɢʀσᴜᴘs / ᴄʜᴧηηєʟs</b>\n<b>✦ ηᴏ ʟᴧɢ • ηᴏ ᴧᴅs • ηᴏ ʙᴜɢs • 24/7 ᴧʟɪᴠє</b>\n<b>✦ ᴇηᴊᴏʏ ʟᴧɢ ғʀєє ϻᴜsɪᴄ • ᴧᴅᴅ ϻє ηᴏᴡ</b>\n<b>─────────────────────────</b>\n<b>» ᴘʀɪᴠᴧᴛє & sєᴄυʀє sσᴜʀᴄє | ηᴏ ᴅᴧᴛᴧ sʜᴧʀᴇ.</b>\n<b>» ʟɪᴄєηᴄєᴅ ᴜsє | ʏσυтυʙє ᴀᴘɪ sυᴘᴘσʀтєᴅ.</b>\n<b>──────────────────────</b></blockquote>',
}
...
def language(fn):
    async def wrapper(client, message):
        try: _ = get_string(await get_lang(message.chat.id))
        except: _ = get_string("en")
        return await fn(client, message, _)
    return wrapper

def languageCB(fn):
    async def wrapper(client, cq):
        try: _ = get_string(await get_lang(cq.message.chat.id))
        except: _ = get_string("en")
        return await fn(client, cq, _)
    return wrapper

def LanguageStart(fn):
    async def wrapper(client, message):
        try:
            lid = message.from_user.id if message.chat.type == ChatType.PRIVATE else message.chat.id
            _ = get_string(await get_lang(lid))
        except: _ = get_string("en")
        return await fn(client, message, _)
    return wrapper
...
def PlayWrapper(fn):
    async def wrapper(client, message):
        ...
        url = " ".join(message.command[1:]) if len(message.command) > 1 else None
        return await fn(client, message, _, chat_id, video, channel, playmode, url, fplay)
    return wrapper
...
def stream_markup(_, chat_id, elapsed=0, total=0):
    from SHUKLAMUSIC.plugins.admins import _build_progress_bar
...
def playlist_markup(_, videoid, user_id, ptype, channel, fplay):
    return [[
        InlineKeyboardButton(_["P_B_1"], callback_data=f"SHUKLAPlaylists {videoid}|{user_id}|{ptype}|a|{channel}|{fplay}"),
        InlineKeyboardButton(_["P_B_2"], callback_data=f"SHUKLAPlaylists {videoid}|{user_id}|{ptype}|v|{channel}|{fplay}"),
    ],[InlineKeyboardButton(_["CLOSE_BUTTON"], callback_data=f"forceclose {videoid}|{user_id}")]]
...
def botplaylist_markup(_):
    return [[InlineKeyboardButton(_["S_B_9"], url=config.SUPPORT_CHAT),
             InlineKeyboardButton(_["CLOSE_BUTTON"], callback_data="close")]]

def close_markup(_):
    return InlineKeyboardMarkup([[InlineKeyboardButton(_["CLOSE_BUTTON"], callback_data="close")]])

def supp_markup(_):
    return InlineKeyboardMarkup([[InlineKeyboardButton(_["S_B_9"], url=config.SUPPORT_CHAT)]])

def aq_markup(_, chat_id):
    return [[InlineKeyboardButton(_["CLOSE_BUTTON"], callback_data="close")]]

def start_panel(_):
    return [[
        InlineKeyboardButton(_["S_B_1"], url=f"https://t.me/{config.BOT_USERNAME}?startgroup=true"),
        InlineKeyboardButton(_["S_B_2"], url=config.SUPPORT_CHAT),
    ]]

def private_panel(_):
    return [
        [InlineKeyboardButton(_["S_B_3"], url=f"https://t.me/{config.BOT_USERNAME}?startgroup=true")],
        [InlineKeyboardButton(_["S_B_5"], user_id=config.OWNER_ID),
         InlineKeyboardButton(_["S_B_10"], callback_data="shiv_Shashank")],
        [InlineKeyboardButton(_["S_B_2"], url=config.SUPPORT_CHAT),
         InlineKeyboardButton(_["S_B_6"], url=config.SUPPORT_CHANNEL)],
        [InlineKeyboardButton(_["S_B_4"], callback_data="help_start")],
        [InlineKeyboardButton("sᴏᴜʀᴄᴇ", callback_data="source_alert")],
    ]

def stats_buttons(_, is_sudo):
    rows = [[InlineKeyboardButton(_["SA_B_1"], callback_data="TopOverall")]]
    if is_sudo:
        rows = [[InlineKeyboardButton(_["SA_B_2"], callback_data="bot_stats_sudo"),
                 InlineKeyboardButton(_["SA_B_3"], callback_data="TopOverall")]]
    rows.append([InlineKeyboardButton(_["CLOSE_BUTTON"], callback_data="close")])
...
# ── Database (in-memory) ──────────────────────────────────────────────────────
# ── Active chats (in-memory only, stream tracking) ───────────────────────────
_active_chats: set = set()
_active_video: set = set()
_cmode_map: dict = {}

async def is_active_chat(cid): return cid in _active_chats
async def add_active_chat(cid): _active_chats.add(cid)
async def remove_active_chat(cid): _active_chats.discard(cid)
async def add_active_video_chat(cid): _active_video.add(cid)
async def remove_active_video_chat(cid): _active_video.discard(cid)
async def get_cmode(cid): return _cmode_map.get(cid)
async def is_on_off(x): return False

# ── Persistent DB functions (Supabase) ───────────────────────────────────────
from SHUKLAMUSIC.database import (
    add_served_chat, get_served_chats,
    add_served_user, get_served_users,
    get_lang, set_lang,
    get_playmode, set_playmode,
    is_banned_user, get_banned_users,
    get_gbanned, blacklisted_chats,
    get_sudoers,
)

# ── Queue ─────────────────────────────────────────────────────────────────────
async def put_queue(chat_id, original_chat_id, file, title, duration, user, vidid, user_id, stream, forceplay=None):
    from SHUKLAMUSIC.misc import db
    from config import autoclean, time_to_seconds
    title = title.title()
    try: secs = time_to_seconds(duration)
    except: secs = 0
    put = {"title": title, "dur": duration, "streamtype": stream, "by": user,
           "user_id": user_id, "chat_id": original_chat_id, "file": file,
           "vidid": vidid, "seconds": secs, "played": 0}
    if forceplay:
        check = db.get(chat_id)
        if check: check.insert(0, put)
        else: db[chat_id] = [put]
    else:
        db.setdefault(chat_id, []).append(put)
    autoclean.append(file)

async def put_queue_index(chat_id, original_chat_id, file, title, duration, user, vidid, stream, forceplay=None):
    from SHUKLAMUSIC.misc import db
    put = {"title": title, "dur": duration, "streamtype": stream, "by": user,
           "chat_id": original_chat_id, "file": file, "vidid": vidid, "seconds": 0, "played": 0}
    if forceplay:
        check = db.get(chat_id)
        if check: check.insert(0, put)
        else: db[chat_id] = [put]
...
async def bot_sys_stats():
    ...
    DISK = f"{round(disk.used/disk.total*100)}%"
    return UP, CPU, RAM, DISK

def seconds_to_min(secs):
    m, s = divmod(int(secs), 60); h, m = divmod(m, 60)
    return f"{h:02d}:{m:02d}:{s:02d}" if h else f"{m:02d}:{s:02d}"

def get_readable_time(secs): return seconds_to_min(secs)

formats = ["mp4", "mkv", "mp3", "flac", "wav", "ogg", "webm", "mov", "avi"]

async def SHUKLABin(text): return config.SUPPORT_CHAT
async def get_thumb(videoid): return f"https://img.youtube.com/vi/{videoid}/hqdefault.jpg"
async def play_logs(message, streamtype=""):
    """
    Jab bhi koi user kisi group/channel mein song play kare,
    yeh function LOGGER_ID group mein details bhej deta hai:
    kis user ne, kis group mein, kaunsa gaana play kiya.
    """
    try:
        ...
        try:
            if len(message.command) > 1:
                ...
                if rep.audio:
                    song_query = rep.audio.file_name or rep.audio.title or "Audio File"
                elif rep.video:
                    song_query = rep.video.file_name or "Video File"
                elif rep.document:
                    song_query = rep.document.file_name or "Document File"
        except Exception:
            pass

        text = (
            "🎵 <b>ɴᴇᴡ ᴘʟᴀʏ ʟᴏɢ</b>\n\n"
            f"👤 <b>ᴜsᴇʀ :</b> {user_mention} [<code>{user_id}</code>]\n"
            f"💬 <b>ɢʀᴏᴜᴘ :</b> {chat_title}\n"
            f"🆔 <b>ɢʀᴏᴜᴘ ɪᴅ :</b> <code>{chat_id}</code>\n"
            f"🎶 <b>ǫᴜᴇʀʏ/sᴏɴɢ :</b> {song_query}\n"
            f"📡 <b>sᴏᴜʀᴄᴇ :</b> {streamtype}"
        )
        ...
        print(f"[PLAY LOGS ERROR] {e}")
async def get_channeplayCB(_, cplay, CallbackQuery): return CallbackQuery.message.chat.id, None
...
# ── Loop control ──────────────────────────────────────────────────────────────
_loop_map: dict = {}
_start_time: dict = {}   # chat_id -> float (unix ts when song started)

async def get_loop(chat_id: int) -> int:
    return _loop_map.get(chat_id, 0)

async def set_loop(chat_id: int, count: int):
    _loop_map[chat_id] = count

# ── Music state ───────────────────────────────────────────────────────────────
async def music_on(chat_id: int):
    _active_chats.add(chat_id)

# ── Autoend (disabled by default) ────────────────────────────────────────────
async def is_autoend() -> bool:
    return False

# ── Group assistant selector ──────────────────────────────────────────────────
async def group_assistant(call_instance, chat_id: int):
    """Returns the first available PyTgCalls assistant instance."""
    import config as _config
    for string, client in [
        (_config.STRING1, call_instance.one),
        (_config.STRING2, call_instance.two),
        (_config.STRING3, call_instance.three),
        (_config.STRING4, call_instance.four),
        (_config.STRING5, call_instance.five),
    ]:
        if string:
            return client
    raise Exception("No assistant string configured")

# ── Media duration (sync, used with run_in_executor) ─────────────────────────
...
# ── Speed converter (used in speedup_stream) ──────────────────────────────────
def speed_converter(current_sec: int, speed) -> tuple:
    """
    Converts already-played seconds to a seek timestamp for the new speed.
    Returns: (ffmpeg_seek_str e.g. '00:01:23', converted_seconds_int)
    """
    new_sec = int(int(current_sec) / float(speed))
    m, s = divmod(new_sec, 60)
    h, m = divmod(m, 60)
    time_str = f"{h:02d}:{m:02d}:{s:02d}" if h else f"{m:02d}:{s:02d}"
    return time_str, new_sec
